...
def load_data():
    ...
    for restaurant in restaurants:
        ...
        labels_matrix.append(restaurant_score(stars, review_count))
        i += 1

    random.shuffle(data_matrix)
    random.shuffle(labels_matrix)
    ...
    testing_labels = labels_matrix[0:test_size]
    training_labels = labels_matrix[test_size + 1: len(labels_matrix)]
